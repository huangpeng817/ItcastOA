...
<body>
	...
	<div id="Title_bar">
		<div id="Title_bar_Head">
			...
			<div id="Title">
				<!--页面标题-->
				<img src="${pageContext.request.contextPath }/style/images/title_arrow.gif" border="0" height="13"
					width="13"> 帖子回复
			</div>
			...
			<center>
				<div class="ItemBlock_Title1">
					<div width="85%" style="float: left">
						<font class="MenuPoint"> &gt; </font> <s:a
							action="forum_list">论坛</s:a> <font class="MenuPoint">
							&gt; </font> <s:a action="forum_show">${topic.forum.name }</s:a> <font
							class="MenuPoint"> &gt;&gt; </font> 帖子回复
					</div>
				</div>
				<div class="ItemBlockBorder">
					<table id="InputArea" border="0" cellpadding="1" cellspacing="1"
						width="100%">
						<tbody>
							<tr>
							...
							<tr>
								...
								<td class="InputAreaBg"><div class="InputContent">
										<input name="title" class="InputStyle" style="width: 100%"
											value="回复：${topic.title }" type="text">
									</div></td>
							</tr>
							<tr height="240">
	...
	<iframe scrolling="no" src="javascript:void(0)"
		style="margin: 0px; padding: 0px; border: 0px none; background-color: transparent; background-image: none; height: 0px; width: 0px; position: absolute; z-index: 10000;"
