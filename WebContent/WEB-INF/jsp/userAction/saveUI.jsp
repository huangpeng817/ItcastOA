...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img src="${pageContext.request.contextPath }/style/images/title_arrow.gif" height="13" border="0" width="13"> 用户信息
        </div>
...
<div id="MainArea">
    <s:form action="user_%{id==null?'add':'edit'}">
        ...
        <div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img src="${pageContext.request.contextPath }/style/blue/images/item_point.gif" height="7" border="0" width="4"> 用户信息 </div> 
        </div>
...
<%--                         	<s:radio name="gender" list="{'男', '女'}"></s:radio> --%>
		...
		<div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img src="${pageContext.request.contextPath }/style/blue/images/item_point.gif" height="7" border="0" width="4"> 岗位设置 </div> 
        </div>
